function [image,xyz,filename,s,res] = OpenXML(filename)
%% function [image,xyz,filename,s,res] = OpenXML(filename)
% opens *Slices.xml files

if nargin == 0
    [filename,PathName] = uigetfile('*Slices.xml','Alte Kalibrierung wählen');
